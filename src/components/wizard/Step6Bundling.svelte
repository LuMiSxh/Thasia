...
{#if wizard.bundle === 'auto'}
  <div style="margin-top:16px;padding:12px;border:1px solid #374151;">
    <label style="display:block;margin-bottom:8px;">
      Volume separator
      <input type="text" bind:value={wizard.volumeSeparator} style="width:120px;margin-left:8px;" />
      <span style="margin-left:8px;color:#6b7280;">e.g. "{wizard.outputName}{wizard.volumeSeparator}1"</span>
    </label>
    <label>
