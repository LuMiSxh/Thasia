...
export function buildConvertOptions(wizard: WizardStore): ConvertOptions {
    return {
        ...
        auto_crop: wizard.autoCrop,
        crop_padding: wizard.cropPadding,
        moire_reduction: wizard.moireReduction,
        eink_dither: wizard.einkDither,
        split_double_page: wizard.splitDoublePage,
